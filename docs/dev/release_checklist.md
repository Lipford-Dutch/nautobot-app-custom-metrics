...
```no-highlight
> poetry version
lipford-nautobot-metrics 1.0.0-beta.2
```
...
Draft a [new release](https://github.com/Lipford-Dutch/nautobot-app-lipford-nautobot-metrics/releases/new) with the following parameters.
...
- Change the entries generated by GitHub to only the usernames of the contributors. e.g. `* Updated dockerfile by @nautobot_user in https://github.com/Lipford-Dutch/nautobot-app-lipford-nautobot-metrics/pull/123` -> `* @nautobot_user`.
...
**Full Changelog**: https://github.com/Lipford-Dutch/nautobot-app-lipford-nautobot-metrics/compare/v1.4.1...v1.4.2
```
