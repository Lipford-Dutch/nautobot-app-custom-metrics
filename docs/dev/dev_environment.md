...
#14 naming to docker.io/lipford-nautobot-metrics/nautobot:3.1.3-py3.14 done
```
...
Creating network "lipford_nautobot_metrics_default" with the default driver
Creating volume "lipford_nautobot_metrics_postgres_data" with default driver
Creating lipford_nautobot_metrics_redis_1 ...
Creating lipford_nautobot_metrics_docs_1  ...
Creating lipford_nautobot_metrics_postgres_1 ...
Creating lipford_nautobot_metrics_postgres_1 ... done
Creating lipford_nautobot_metrics_redis_1    ... done
Creating lipford_nautobot_metrics_nautobot_1 ...
Creating lipford_nautobot_metrics_docs_1     ... done
Creating lipford_nautobot_metrics_nautobot_1 ... done
Creating lipford_nautobot_metrics_worker_1   ...
Creating lipford_nautobot_metrics_worker_1   ... done
...
ee90fbfabd77   lipford-nautobot-metrics/nautobot:3.1.3-py3.14  "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               lipford_nautobot_metrics_worker_1
b8adb781d013   lipford-nautobot-metrics/nautobot:3.1.3-py3.14  "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   lipford_nautobot_metrics_nautobot_1
d64ebd60675d   lipford-nautobot-metrics/nautobot:3.1.3-py3.14  "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   lipford_nautobot_metrics_docs_1
e72d63129b36   postgres:13-alpine               "docker-entrypoint.s…"   25 seconds ago   Up 19 seconds   0.0.0.0:5432->5432/tcp, :::5432->5432/tcp   lipford_nautobot_metrics_postgres_1
96c6ff66997c   redis:6-alpine                   "docker-entrypoint.s…"   25 seconds ago   Up 21 seconds   0.0.0.0:6379->6379/tcp, :::6379->6379/tcp   lipford_nautobot_metrics_redis_1
```
...
Stopping lipford_nautobot_metrics_worker_1   ...
Stopping lipford_nautobot_metrics_nautobot_1 ...
Stopping lipford_nautobot_metrics_docs_1     ...
Stopping lipford_nautobot_metrics_redis_1    ...
Stopping lipford_nautobot_metrics_postgres_1 ...
Stopping lipford_nautobot_metrics_worker_1   ... done
Stopping lipford_nautobot_metrics_nautobot_1 ... done
Stopping lipford_nautobot_metrics_postgres_1 ... done
Stopping lipford_nautobot_metrics_redis_1    ... done
Stopping lipford_nautobot_metrics_docs_1     ... done
Removing lipford_nautobot_metrics_worker_1   ...
Removing lipford_nautobot_metrics_nautobot_1 ...
Removing lipford_nautobot_metrics_docs_1     ...
Removing lipford_nautobot_metrics_redis_1    ...
Removing lipford_nautobot_metrics_postgres_1 ...
Removing lipford_nautobot_metrics_postgres_1 ... done
Removing lipford_nautobot_metrics_docs_1     ... done
Removing lipford_nautobot_metrics_worker_1   ... done
Removing lipford_nautobot_metrics_redis_1    ... done
Removing lipford_nautobot_metrics_nautobot_1 ... done
Removing network lipford_nautobot_metrics_default
```
...
So for example, our app is named `lipford-nautobot-metrics`, the command would most likely be `docker logs lipford_nautobot_metrics_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
```python
namespace = Collection("lipford_nautobot_metrics")
namespace.configure(
    {
        "lipford_nautobot_metrics": {
            ...
...
Or set the `INVOKE_LIPFORD_NAUTOBOT_METRICS_PYTHON_VER` variable.
...
Or set the `INVOKE_LIPFORD_NAUTOBOT_METRICS_NAUTOBOT_VER` variable.
...
In the package source, there is the `lipford_nautobot_metrics/app-config-schema.json` file, conforming to the [JSON Schema](https://json-schema.org/) format. This file is used to validate the configuration of the app in CI pipelines.
